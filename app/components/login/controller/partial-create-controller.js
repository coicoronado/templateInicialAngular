'use strict';
angular.module('myApp.loginCreate-controller', ['ngRoute'])

.controller('LoginCreateController', ['$scope','$document','$rootScope',
                    function($scope, $document, $rootScope) {
  $scope.data='algo de aca';

}])

// Logic that comes from Neon theme
.directive('loginInit', function(){
  return {
    restrict: 'A',
